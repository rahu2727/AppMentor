"""
week2/sources/router_agent.py — Detects code language and selects the expert prompt.
...
class RouterAgent:
    ...
    def detect_language(self, file_path: str, content: str) -> str:
        ...
        content : str
            Source code text (used for indicator scoring).

        Returns
        -------
        str
            Language key matching a key in LANGUAGE_RULES.
        """
