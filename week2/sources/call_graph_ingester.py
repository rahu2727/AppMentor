"""
week2/sources/call_graph_ingester.py
...
Public API
----------
    from sources.call_graph_ingester import run
...
def _extract_call_graph(
    ...
    (same filter as code_commentary_ingester).
    """
    try:
...
# ---------------------------------------------------------------------------
# Module path resolution  (mirrors code_commentary_ingester)
# ---------------------------------------------------------------------------
