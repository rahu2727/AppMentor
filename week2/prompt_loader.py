"""
week2/prompt_loader.py — Loads and caches AI prompts from week2/prompts/*.yaml.
...
class PromptLoader:
    """
    Loads prompt YAML files from week2/prompts/ and provides typed accessors.
    ...
    def __init__(self, prompts_dir: str = "week2/prompts") -> None:
    ...
    def summary(self) -> str:
        ...
        for name in prompts:
            try:
                ...
                # Extract status from description: first sentence containing
                # "Placeholder" or "Tested"
