"""
week3/agents/counsel.py — The Counsel: grounded answer generation + self-reflection.
...
def counsel_node(state: AppMentorState) -> dict:
    ...
    quality_score, quality_details = _evaluate_quality(client, question, raw_answer, role, context)
