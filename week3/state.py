"""
week3/state.py — Shared state TypedDict for the appMentor LangGraph pipeline.
...
class AppMentorState(TypedDict, total=False):
    # ── Inputs ────────────────────────────────────────────────────────────────
    user_question: str       # original question from the user
    user_role: str           # developer | business_user | manager | system_admin | consultant
